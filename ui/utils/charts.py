...
utils/charts.py
───────────────
Shared Plotly layout constants and colour helpers.
...
CHART_LAYOUT = dict(
    ...
    legend=dict(bgcolor="#1a1f35", borderwidth=0),
)

REGIME_FILL  = {"Trending": "rgba(52,211,153,0.18)",
                "Ranging":  "rgba(99,179,237,0.18)",
                "Volatile": "rgba(248,113,113,0.20)"}
REGIME_COLOR = {"Trending": "#34d399", "Ranging": "#63b3ed", "Volatile": "#f87171"}

CANDLE_UP   = "#34d399"
CANDLE_DOWN = "#f87171"
EMA_COLORS  = {9: "#60a5fa", 21: "#f59e0b", 50: "#a78bfa", 200: "#94a3b8"}
...
def apply_base_layout(fig: go.Figure, height: int = 500,
    ...
    fig.update_yaxes(showgrid=True, gridcolor="#1e2538", gridwidth=0.5)
    return fig
